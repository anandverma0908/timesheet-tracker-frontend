...
export const QUERY_KEYS = {
  tickets:  (params: Record<string, string | null | undefined>) => ['tickets', params] as const,
  summary:  (params: Record<string, string | null | undefined>) => ['summary', params] as const,
...
export type DatePreset = 'today' | 'thisMonth' | 'lastMonth' | 'thisQuarter' | 'thisFY' | 'custom'
