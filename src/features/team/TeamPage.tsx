  ...
  return (
    <div className={styles.page}>
      ...
      <div className={`${styles.header} fade-up`}>
        <div>
          ...
          <p className={styles.subtitle}>
            {isLoading ? 'Loading…' : `${engineers.length} engineers · ${allPods.length} PODs`}
          </p>
        </div>
      ...
      <div className={`${styles.controls} fade-up-1`}>
        ...
        {allPods.map(pod => (
          <button
            ...
            style={selectedPod === pod ? { background: getPodColor(pod), borderColor: getPodColor(pod) } : {}}
      ...
      {isLoading ? (
        ...
        <EmptyState icon="👥" title="No engineers found" desc="Try a different POD or search term." />
      ) : (
              ...
              <div className={styles.stats}>
                <div className={styles.stat}>
                  <div
                    ...
                    style={{ color: getAvatarColor(eng.user).includes('4F7EFF') ? 'var(--accent)' : undefined }}
                  >
